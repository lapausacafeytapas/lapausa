...
const PRODUCTOS = {
  ...
  bebidas: {
    ...
    cervezas: [
      { nombre: "Doble Águila Dorada", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/5 Amstel", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Amstel", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Radler", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "Cerveza sin gluten", descripcion: "Cerveza.", precio: "", alergenos: "", por_unidad: false },
      { nombre: "1/3 Amstel Oro", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Amstel Oro sin alcohol", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Águila sin filtrar", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Heineken", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Heineken sin alcohol", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "Desperados", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "Ladrón de manzanas", descripcion: "Sidra.", precio: "", alergenos: "", por_unidad: false },
      { nombre: "Lagunitas IPA", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/5 Estrella Galicia", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Estrella Galicia", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false },
      { nombre: "1/3 Estrella Galicia sin alcohol", descripcion: "Cerveza.", precio: "", alergenos: "G", por_unidad: false }
    ],
